...
<link rel="stylesheet" href="/css/user/coupleNote.css">
<script src="/js/user/coupleNote.js"></script>

<section class="mypage-sec">
    <div class="gallery">
		<figure class="gallery__item" data-aos="fade-up" data-aos-duration="1000">
