        ...
        <div class="form-container">
            <form action="reg" method="post" class="form">
                ...
                <div class="info-container">
                    ...
                    <div class="input-container">
                        <input type="text" class="info-input birthday" name="birthday" placeholder="1990-12-31" autocomplete="off" pattern="^\d{4}-\d{2}-\d{2}$" required>
                    </div>
                </div>
                <div class="info-container">
                    <div class="icon-container">
                    ...
                    <div class="input-container">
                        <input type="tel" class="info-input phone" name="phone" placeholder="010-0000-0000" autocomplete="off" pattern="^01[01678]-\d{3,4}-\d{4}$" required>
                    </div>                        
                </div>
                <div>
